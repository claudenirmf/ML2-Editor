...
public enum CategorizationType implements Enumerator
{
   ...
   * @ordered
   */
  COMPLETE_CATEGORIZER(1, "COMPLETE_CATEGORIZER", "completeCategorizes"),
   ...
   * @ordered
   */
  PARTITIONER(3, "PARTITIONER", "partitions");
   ...
   * @ordered
   */
  public static final int COMPLETE_CATEGORIZER_VALUE = 1;
   ...
   * @ordered
   */
  public static final int PARTITIONER_VALUE = 3;
