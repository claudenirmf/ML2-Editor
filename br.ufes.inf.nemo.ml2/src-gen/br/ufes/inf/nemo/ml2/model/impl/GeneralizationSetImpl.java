...
public class GeneralizationSetImpl extends ModelElementImpl implements GeneralizationSet
{
   ...
   * @ordered
   */
  protected br.ufes.inf.nemo.ml2.model.Class general;
   ...
   * @ordered
   */
  protected HigherOrderClass categorizer;
   ...
   * @ordered
   */
  protected EList<br.ufes.inf.nemo.ml2.model.Class> specifics;
   ...
   */
  @Override
  public br.ufes.inf.nemo.ml2.model.Class getGeneral()
  {
    if (general != null && general.eIsProxy())
    {
      InternalEObject oldGeneral = (InternalEObject)general;
      general = (br.ufes.inf.nemo.ml2.model.Class)eResolveProxy(oldGeneral);
   ...
   * @generated
   */
  public br.ufes.inf.nemo.ml2.model.Class basicGetGeneral()
  {
    return general;
  }
   ...
   */
  @Override
  public void setGeneral(br.ufes.inf.nemo.ml2.model.Class newGeneral)
  {
    br.ufes.inf.nemo.ml2.model.Class oldGeneral = general;
    general = newGeneral;
    if (eNotificationRequired())
   ...
   * @generated
   */
  public HigherOrderClass basicGetCategorizer()
  {
    return categorizer;
  }
   ...
   */
  @Override
  public void setCategorizer(HigherOrderClass newCategorizer)
  {
    HigherOrderClass oldCategorizer = categorizer;
   ...
   */
  @Override
  public EList<br.ufes.inf.nemo.ml2.model.Class> getSpecifics()
  {
    if (specifics == null)
    {
      specifics = new EObjectResolvingEList<br.ufes.inf.nemo.ml2.model.Class>(br.ufes.inf.nemo.ml2.model.Class.class, this, ModelPackage.GENERALIZATION_SET__SPECIFICS);
    }
    return specifics;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case ModelPackage.GENERALIZATION_SET__NAME:
        ...
        return;
      case ModelPackage.GENERALIZATION_SET__GENERAL:
        setGeneral((br.ufes.inf.nemo.ml2.model.Class)newValue);
        return;
      case ModelPackage.GENERALIZATION_SET__CATEGORIZER:
        setCategorizer((HigherOrderClass)newValue);
        return;
      case ModelPackage.GENERALIZATION_SET__SPECIFICS:
        getSpecifics().clear();
        getSpecifics().addAll((Collection<? extends br.ufes.inf.nemo.ml2.model.Class>)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      ...
      case ModelPackage.GENERALIZATION_SET__NAME:
        ...
        return;
      case ModelPackage.GENERALIZATION_SET__GENERAL:
        setGeneral((br.ufes.inf.nemo.ml2.model.Class)null);
        return;
      case ModelPackage.GENERALIZATION_SET__CATEGORIZER:
        setCategorizer((HigherOrderClass)null);
        return;
      case ModelPackage.GENERALIZATION_SET__SPECIFICS:
        getSpecifics().clear();
        return;
