 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.ml2.model.impl.GeneralizationSetImpl#getName <em>Name</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.model.impl.GeneralizationSetImpl#isIsDisjoint <em>Is Disjoint</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.model.impl.GeneralizationSetImpl#isIsComplete <em>Is Complete</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.model.impl.GeneralizationSetImpl#getGeneral <em>General</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.model.impl.GeneralizationSetImpl#getCategorizer <em>Categorizer</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.model.impl.GeneralizationSetImpl#getSpecifics <em>Specifics</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneralizationSetImpl extends ModelElementImpl implements GeneralizationSet {
	...
	public EList<ML2Class> getSpecifics() {
		if (specifics == null) {
			specifics = new EObjectResolvingEList<ML2Class>(ML2Class.class, this, ModelPackage.GENERALIZATION_SET__SPECIFICS);
		}
		return specifics;
	}
