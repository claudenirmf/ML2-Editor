...
public class ML2LinguistcRulesTest {
  ...
  public void testIsNameValid() {
    try {
      ...
      this._validationTestHelper.assertError(incorrectModel, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_ENTITY_DECLARATION_NAME);
    } catch (Throwable _e) {
  ...
  public void testIsValidSpecialization() {
    try {
      ...
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_CLASS_SPECIALIZATION);
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append(" ");
      ...
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_CLASS_SPECIALIZATION);
      ...
      this._validationTestHelper.assertError(incorrectModelC, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_CLASS_SPECIALIZATION);
      ...
      this._validationTestHelper.assertError(incorrectModelD, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_CLASS_SPECIALIZATION);
  ...
  public void testHasCyclicSpecialization() {
    try {
      ...
      _builder.append("module t{ class A specializes A; }");
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.CYCLIC_SPECIALIZATION);
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append(" ");
      ...
      _builder_1.append("}");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.CYCLIC_SPECIALIZATION);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  public void testHasValidBasetype() {
    try {
      ...
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_CATEGORIZED_CLASS);
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("module t { order 2 class A categorizes B; order 2 class B ; }");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_CATEGORIZED_CLASS);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("module t { order 3 class A categorizes B; order 3 class B; }");
      final ML2Model incorrectModelC = this._parseHelper.parse(_builder_2);
      this._validationTestHelper.assertError(incorrectModelC, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_CATEGORIZED_CLASS);
      StringConcatenation _builder_3 = new StringConcatenation();
  ...
  public void testHasValidPowertypeRelation() {
    try {
      ...
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_POWERTYPE_RELATION);
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("module t { order 2 class A isPowertypeOf B; order 2 class B; }");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_POWERTYPE_RELATION);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("module t { order 3 class A isPowertypeOf B; order 3 class B; }");
      final ML2Model incorrectModelC = this._parseHelper.parse(_builder_2);
      this._validationTestHelper.assertError(incorrectModelC, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_POWERTYPE_RELATION);
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append("module t {");
      _builder_3.newLine();
      _builder_3.append("\t\t\t\t");
  ...
  public void testHasValidSubordinators() {
    try {
      ...
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_SUBORDINATOR);
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("module t { order 2 class A subordinatedTo B; class B; }");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_SUBORDINATOR);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("module t { order 2 class A subordinatedTo B; order 3 class B; }");
      final ML2Model incorrectModelC = this._parseHelper.parse(_builder_2);
      this._validationTestHelper.assertError(incorrectModelC, MetaPackage.eINSTANCE.getML2Class(), LinguisticRules.INVALID_SUBORDINATOR);
      StringConcatenation _builder_3 = new StringConcatenation();
  ...
  public void testDuplicatedNames() {
    try {
      ...
      this._validationTestHelper.assertError(incorrectModel, MetaPackage.eINSTANCE.getEntityDeclaration(), LinguisticRules.DUPLICATED_ENTITY_NAME);
      StringConcatenation _builder_1 = new StringConcatenation();
  ...
  public void testHasValidMembers() {
    try {
      ...
      _builder.append("}");
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getGeneralizationSet(), 
      ...
      _builder_1.append("}");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getGeneralizationSet(), 
        LinguisticRules.INVALID_GENERALIZATION_SET_MEMBERS);
      StringConcatenation _builder_2 = new StringConcatenation();
      ...
      _builder_2.append("}");
      final ML2Model incorrectModelC = this._parseHelper.parse(_builder_2);
      this._validationTestHelper.assertError(incorrectModelC, MetaPackage.eINSTANCE.getGeneralizationSet(), 
        LinguisticRules.INVALID_GENERALIZATION_SET_MEMBERS);
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append("module t {");
      _builder_3.newLine();
  ...
  public void testObeysSubordination() {
    try {
      ...
      _builder.append("}");
      final ML2Model incorrectModel = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModel, MetaPackage.eINSTANCE.getML2Class(), 
  ...
  public void testHasSimpleSubordinationCycle() {
    try {
      ...
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getML2Class(), 
      ...
      _builder_1.append("}");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getML2Class(), 
        LinguisticRules.SIMPLE_SUBORDINATION_CYCLE);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("module t{");
      _builder_2.newLine();
      ...
      _builder_2.append("}");
      final ML2Model incorrectModelC = this._parseHelper.parse(_builder_2);
      this._validationTestHelper.assertError(incorrectModelC, MetaPackage.eINSTANCE.getML2Class(), 
        LinguisticRules.SIMPLE_SUBORDINATION_CYCLE);
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append("module t{");
      _builder_3.newLine();
  ...
  public void testIsSpecializingDisjointClasses() {
    try {
      ...
      _builder.append("}");
      final ML2Model incorrectModel = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertWarning(incorrectModel, MetaPackage.eINSTANCE.getML2Class(), 
      ...
      _builder_1.append("}");
      final ML2Model correctModel = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertNoWarnings(correctModel, MetaPackage.eINSTANCE.getML2Class(), 
        LinguisticRules.SPECILIZATION_OF_DISJOINT_CLASSES);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  ...
  public void testIsInstanceOfDisjointClasses() {
    try {
      ...
      _builder.append("}");
      final ML2Model incorrectModel = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertWarning(incorrectModel, MetaPackage.eINSTANCE.getEntityDeclaration(), 
      ...
      _builder_1.append("}");
      final ML2Model correctModel = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertNoWarnings(correctModel, MetaPackage.eINSTANCE.getEntityDeclaration(), 
        LinguisticRules.INSTANCE_OF_DISJOINT_CLASSES);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  ...
  public void testSubsettedMultiplicity() {
    try {
      ...
      _builder.append("}");
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getReference(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getAttribute(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("module t {");
      _builder_1.newLine();
      ...
      _builder_1.append("}");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getReference(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getAttribute(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("module t {");
      _builder_2.newLine();
  ...
  public void testMultiplicityAndAssignment() {
    try {
      ...
      _builder.append("}");
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertWarning(incorrectModelA, MetaPackage.eINSTANCE.getReferenceAssignment(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      this._validationTestHelper.assertWarning(incorrectModelA, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      StringConcatenation _builder_1 = new StringConcatenation();
      _builder_1.append("module t {");
      _builder_1.newLine();
      ...
      _builder_1.append("}");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertWarning(incorrectModelB, MetaPackage.eINSTANCE.getReferenceAssignment(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      this._validationTestHelper.assertWarning(incorrectModelB, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("module t {");
      _builder_2.newLine();
      ...
      _builder_2.append("}");
      final ML2Model correctModel = this._parseHelper.parse(_builder_2);
      this._validationTestHelper.assertNoWarnings(correctModel, MetaPackage.eINSTANCE.getReferenceAssignment(), 
        LinguisticRules.INVALID_MULTIPLICITY);
      this._validationTestHelper.assertNoWarnings(correctModel, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.INVALID_MULTIPLICITY);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  ...
  public void testCheckFeatureAssignmentType() {
    try {
      ...
      this._validationTestHelper.assertNoErrors(correctModelB, MetaPackage.eINSTANCE.getAttributeAssignment(), 
  ...
  public void testCheckRegularityAndContainer() {
    try {
      ...
      _builder.append("}");
      final ML2Model incorrectModelA = this._parseHelper.parse(_builder);
      this._validationTestHelper.assertError(incorrectModelA, MetaPackage.eINSTANCE.getFeature(), 
      ...
      _builder_1.append("}");
      final ML2Model incorrectModelB = this._parseHelper.parse(_builder_1);
      this._validationTestHelper.assertError(incorrectModelB, MetaPackage.eINSTANCE.getFeature(), 
        LinguisticRules.FIRST_ORDER_REGULARITY);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("module t {");
      _builder_2.newLine();
      ...
      _builder_2.append("}");
      final ML2Model incorrectModelC = this._parseHelper.parse(_builder_2);
      this._validationTestHelper.assertError(incorrectModelC, MetaPackage.eINSTANCE.getFeature(), 
      ...
      _builder_3.append("}");
      final ML2Model incorrectModelD = this._parseHelper.parse(_builder_3);
      this._validationTestHelper.assertError(incorrectModelD, MetaPackage.eINSTANCE.getFeature(), 
        LinguisticRules.RESTRICTED_REGULARITY_TYPE);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  ...
  public void testCheckInstantiatedRegularities() {
    try {
      ...
      this._validationTestHelper.assertWarning(incorretModel, MetaPackage.eINSTANCE.getML2Class(), 
      ...
      this._validationTestHelper.assertNoWarnings(corretModel, MetaPackage.eINSTANCE.getML2Class(), 
        LinguisticRules.MISSING_ASSIGNMENT_BY_REGULARITY);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  ...
  public void testCheckRegularityFeatureConformance() {
    try {
      ...
      this._validationTestHelper.assertWarning(incorretModelA, MetaPackage.eINSTANCE.getReferenceAssignment(), 
      ...
      this._validationTestHelper.assertNoWarnings(corretModelA, MetaPackage.eINSTANCE.getReferenceAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      StringConcatenation _builder_2 = new StringConcatenation();
      _builder_2.append("module t {");
      _builder_2.newLine();
      ...
      this._validationTestHelper.assertWarning(incorretModelB, MetaPackage.eINSTANCE.getReferenceAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      StringConcatenation _builder_3 = new StringConcatenation();
      _builder_3.append("module t {");
      _builder_3.newLine();
      ...
      this._validationTestHelper.assertNoWarnings(corretModelB, MetaPackage.eINSTANCE.getReferenceAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      StringConcatenation _builder_4 = new StringConcatenation();
      _builder_4.append("module t {");
      _builder_4.newLine();
      ...
      this._validationTestHelper.assertWarning(incorretModelC1, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      ...
      this._validationTestHelper.assertWarning(incorretModelC2, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      ...
      this._validationTestHelper.assertNoWarnings(corretModelC, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      ...
      this._validationTestHelper.assertWarning(incorretModelD1, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      ...
      this._validationTestHelper.assertWarning(incorretModelD2, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      ...
      this._validationTestHelper.assertNoWarnings(incorretModelD, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      ...
      this._validationTestHelper.assertWarning(incorretModelE1, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      ...
      this._validationTestHelper.assertWarning(incorretModelE2, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
      ...
      this._validationTestHelper.assertNoWarnings(corretModelE, MetaPackage.eINSTANCE.getAttributeAssignment(), 
        LinguisticRules.NON_CONFORMANT_REGULATED_FEATURE_ASSIGNMENT);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
