...
public class ML2Formatter extends AbstractFormatter2 {
  ...
  protected void _format(final ML2Model mL2Model, @Extension final IFormattableDocument document) {
  ...
  public void format(final Object individual, final IFormattableDocument document) {
    if (individual instanceof Individual) {
      ...
      return;
    } else if (individual instanceof ML2Model) {
      _format((ML2Model)individual, document);
      return;
