...
public class MetaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case MetaPackage.ENTITY_DECLARATION: {
			...
			case MetaPackage.ORDERED_CLASS: {
			...
			case MetaPackage.FEATURE_ASSIGNMENT: {
