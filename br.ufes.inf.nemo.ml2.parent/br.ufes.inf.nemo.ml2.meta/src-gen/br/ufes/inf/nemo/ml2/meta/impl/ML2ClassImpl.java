 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.ml2.meta.impl.ML2ClassImpl#getSuperClasses <em>Super Classes</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.meta.impl.ML2ClassImpl#getSubordinators <em>Subordinators</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.meta.impl.ML2ClassImpl#getPowertypeOf <em>Powertype Of</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.meta.impl.ML2ClassImpl#getCategorizedClass <em>Categorized Class</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.meta.impl.ML2ClassImpl#getCategorizationType <em>Categorization Type</em>}</li>
 *   <li>{@link br.ufes.inf.nemo.ml2.meta.impl.ML2ClassImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ML2ClassImpl extends EntityDeclarationImpl implements ML2Class {
	...
	protected EClass eStaticClass() {
		return MetaPackage.Literals.ML2_CLASS;
	}
	...
	public EList<ML2Class> getSuperClasses() {
		if (superClasses == null) {
			superClasses = new EObjectResolvingEList<ML2Class>(ML2Class.class, this, MetaPackage.ML2_CLASS__SUPER_CLASSES);
		}
		return superClasses;
	}
	...
	public EList<ML2Class> getSubordinators() {
		if (subordinators == null) {
			subordinators = new EObjectResolvingEList<ML2Class>(ML2Class.class, this, MetaPackage.ML2_CLASS__SUBORDINATORS);
		}
		...
		if (powertypeOf != null && powertypeOf.eIsProxy()) {
			...
			if (powertypeOf != oldPowertypeOf) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetaPackage.ML2_CLASS__POWERTYPE_OF, oldPowertypeOf, powertypeOf));
			}
		}
		return powertypeOf;
	}
	...
	public void setPowertypeOf(ML2Class newPowertypeOf) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaPackage.ML2_CLASS__POWERTYPE_OF, oldPowertypeOf, powertypeOf));
	}
	...
	public ML2Class getCategorizedClass() {
		if (categorizedClass != null && categorizedClass.eIsProxy()) {
			...
			if (categorizedClass != oldCategorizedClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MetaPackage.ML2_CLASS__CATEGORIZED_CLASS, oldCategorizedClass, categorizedClass));
			}
		}
	...
	public void setCategorizedClass(ML2Class newCategorizedClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaPackage.ML2_CLASS__CATEGORIZED_CLASS, oldCategorizedClass, categorizedClass));
	}
	...
	public void setCategorizationType(CategorizationType newCategorizationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetaPackage.ML2_CLASS__CATEGORIZATION_TYPE, oldCategorizationType, categorizationType));
	}
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentEList<Feature>(Feature.class, this, MetaPackage.ML2_CLASS__FEATURES);
		}
		return features;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MetaPackage.ML2_CLASS__FEATURES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MetaPackage.ML2_CLASS__SUPER_CLASSES:
				return getSuperClasses();
			case MetaPackage.ML2_CLASS__SUBORDINATORS:
				return getSubordinators();
			case MetaPackage.ML2_CLASS__POWERTYPE_OF:
				if (resolve) return getPowertypeOf();
				return basicGetPowertypeOf();
			case MetaPackage.ML2_CLASS__CATEGORIZED_CLASS:
				if (resolve) return getCategorizedClass();
				return basicGetCategorizedClass();
			case MetaPackage.ML2_CLASS__CATEGORIZATION_TYPE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case MetaPackage.ML2_CLASS___GET_ATTRIBUTES:
				return getAttributes();
			case MetaPackage.ML2_CLASS___GET_REFERENCES:
