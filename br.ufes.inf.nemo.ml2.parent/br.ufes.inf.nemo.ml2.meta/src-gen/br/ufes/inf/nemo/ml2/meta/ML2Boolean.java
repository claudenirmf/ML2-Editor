 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.ml2.meta.ML2Boolean#isValue <em>Value</em>}</li>
 * </ul>
 *
 * @see br.ufes.inf.nemo.ml2.meta.MetaPackage#getML2Boolean()
 * @model
 * @generated
 */
public interface ML2Boolean extends Literal {
	 ...
	 * @see br.ufes.inf.nemo.ml2.meta.MetaPackage#getML2Boolean_Value()
	 * @model unique="false"
	 * @generated
	 */
	boolean isValue();
	...
	/**
	 * Sets the value of the '{@link br.ufes.inf.nemo.ml2.meta.ML2Boolean#isValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
